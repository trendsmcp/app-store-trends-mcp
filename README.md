...
The number one Python package for App Store trend data. App Store trends as an MCP tool. Plug into Claude, Cursor, or any MCP-compatible AI host. Weekly series, growth percentages, and live App Store top charts.
...
top     = client.get_top_trends(type="App Store", limit=10)
```
