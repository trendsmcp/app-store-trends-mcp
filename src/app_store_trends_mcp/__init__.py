"""
app-store-trends-mcp -- App Store trends as an MCP tool. Plug into Claude, Cursor, or any MCP-compatible AI host. Weekly series, growth percentages, and live App Store top charts.
